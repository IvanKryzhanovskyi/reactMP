...
import { AuthContext, validateInput } from '../../utils';
...
export const LoginForm = () => {
    ...
    const handleFormSubmit = (e) => {
      e.preventDefault();
      if (formData.nameFiled.isFieldCorrect && formData.passwordField.isFieldCorrect) {
        return setAuthStatus(!isUserAuthorized);
      }
      setFormData(prevState => ({
        ...prevState,
        passwordField: {
